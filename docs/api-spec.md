...
| PATCH  | `/matches/:id/frames/:frameNumber`   | Bearer | `UpdateMatchFrameSchema`       | Edits a frame's scores/break/duration/notes; re-derives the winner from the scores and recomputes the match score/result. Returns the updated match.                                                            |
